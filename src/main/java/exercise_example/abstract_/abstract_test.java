...
public class abstract_test {
    ...
    public static void main(String[] args){
        ...
        Volunteer2 volunteer2 = new Volunteer2("Annann");
...
class Volunteer extends Employee{
    ...
    /** @paramSet the hours instance variable. **/
...
class Volunteer2 extends Volunteer{

    Volunteer2(String name){
        // explicit call to superclass' parameterized constructor
        super(name);
    }
    @Override
    /** Overrides the superclass' print method and prints information about an instance of Volunteer. **/
    void print(){
        System.out.println("Volunteer2 Name: " + this.getName()
                + "\nHours: " + this.getHours());
    }
}
